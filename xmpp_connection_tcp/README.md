...
>本软件是参照开源软件 [xmpp_connection_tcp](https://github.com/xmppjs/xmpp.js/tree/main/packages/connection-tcp)源码并用 TypeScript 语言实现了相关功能，在OpenHarmony上提供了一个用于建立和管理XMPP连接的library
