...
|:---------------:|:------:|:------:|
| isPlainObject() | object | Judgment of ordinary objects |
...
This project is licensed under [MIT License](https://gitcode.com/openharmony-tpc/openharmony_tpc_samples/blob/master/is_plain_object/LICENSE).
