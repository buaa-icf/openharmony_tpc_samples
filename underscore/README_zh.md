...
## 效果展示
<img height="400" src="./screenshot/effect_zh.gif"/>
...
9. 获取当前时间的毫秒数: now()
10. 从集合中获取首一个元素: first(collection)
11. 从集合中获取末尾一个元素: last(collection)
...
## 开源协议
本项目基于 [MIT License](https://gitcode.com/openharmony-tpc/openharmony_tpc_samples/blob/master/underscore/LICENSE) ，请自由地享受和参与开源。
