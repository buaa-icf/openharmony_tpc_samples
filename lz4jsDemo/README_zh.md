...
```
  ohpm install lz4js
  ohpm install @types/lz4js --save-dev //import lz4js 的时候语法报错。其原因是lz4js包内不含类型声明，需要 @types/lz4js 下载这个包的声明文件，从而解决语法的报错。
```
...
本项目基于 [Apache License 2.0](https://gitcode.com/openharmony-tpc/openharmony_tpc_samples/blob/master/lz4jsDemo/LICENSE) ，请自由地享受和参与开源。
