...
更多接口的使用可参考[官方文档](https://mikemcl.github.io/bignumber.js/)，单元测试用例详情见[TEST.md](https://gitcode.com/openharmony-tpc/openharmony_tpc_samples/blob/master/bignumberjsDemo/TEST.md)
## 约束与限制
在下述版本验证通过：
...
本项目基于 [ Apache License 2.0 ](https://gitcode.com/openharmony-tpc/openharmony_tpc_samples/blob/master/bignumberjsDemo/LICENSE) ，请自由地享受和参与开源。
