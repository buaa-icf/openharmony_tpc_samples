...
**单元测试用例详见**[TEST.md](https://gitcode.com/openharmony-tpc/openharmony_tpc_samples/blob/master/json-bigintDemo/TEST.md)
### options参数说明
| 参数                     |说明   |
|------------------------| ------------ |
...
# 开源协议
本项目基于 [ MIT License](https://gitcode.com/openharmony-tpc/openharmony_tpc_samples/blob/master/json-bigintDemo/LICENSE) ，请自由地享受和参与开源。