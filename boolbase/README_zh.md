...
## 贡献代码
使用过程中发现任何问题都可以提 [Issue](https://gitee.com/openharmony-tpc/openharmony_tpc_samples/boolbase/issues) ，当然也非常欢迎直接发 [PR](https://gitee.com/openharmony-tpc/openharmony_tpc_samples/boolbase/pulls) 。

## 开源协议
本项目基于 [ISC](https://gitee.com/openharmony-tpc/openharmony_tpc_samples/boolbase/blob/master/LICENSE) ，请自由地享受和参与开源。