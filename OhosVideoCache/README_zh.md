...
| getCacheSize()          | 无                                                           | 缓存总大小（字节）        | 获取缓存目录的总大小（字节）。                   |


更多模块的使用可参考[官方文档](https://github.com/danikula/AndroidVideoCache/blob/master/README.md)，[单元测试用例](https://gitcode.com/openharmony-tpc/openharmony_tpc_samples/blob/master/OhosVideoCache/TEST.md)

## 关于混淆
- 代码混淆，请查看[代码混淆简介](https://docs.openharmony.cn/pages/v5.0/zh-cn/application-dev/arkts-utils/source-obfuscation.md)
- 如果希望video-cache库在代码混淆过程中不会被混淆，需要在混淆规则配置文件obfuscation-rules.txt中添加相应的排除规则：
```
-keep
...
本项目基于 [Apache License ](https://gitcode.com/openharmony-tpc/openharmony_tpc_samples/blob/master/OhosVideoCache/LICENSE)，请自由地享受和参与开源。
