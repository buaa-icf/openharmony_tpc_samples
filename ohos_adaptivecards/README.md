...
| style         | InputTextStyle | 是    | 支持Text，Tel，Url，Email，Password
...
| 属性             | 类型                        | 是否必填 | 描述                           |
|----------------|---------------------------|------|------------------------------|
| type           | Action.ToggleVisibility | 是    | 必须是Action.ToggleVisibility |
...
| 属性   | 类型               | 是否必填 | 描述                  |
|------|------------------|------|---------------------|
| type | Action.ShowCard | 是    | Action.ShowCard类型 |
...
| 属性   | 类型               | 是否必填 | 描述                  |
|------|------------------|------|---------------------|
| type | Action.Execute | 是    | Action.Execute类型 |
