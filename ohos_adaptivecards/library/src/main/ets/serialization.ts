...
export class PropertyDefinition {
    ...
    readonly onGetInitialValue?: (sender: SerializableObject)=>void;
    ...
    constructor(
        ...
        name: string,
        defaultValue?: any,
        onGetInitialValue?: (sender: SerializableObject) => any
    ) {
        this.targetVersion = targetVersion;
        this.name = name;
...
export class SerializableObjectCollectionProperty extends PropertyDefinition {
    ...
    constructor(
        ...
        readonly name: string,
        readonly objectType: SerializableObjectType,
        readonly onItemAdded?: (sender: SerializableObject, item: SerializableObject | ESObject) => void
    ) {
...
export type PropertyBag = Record< number , string|undefined>;
