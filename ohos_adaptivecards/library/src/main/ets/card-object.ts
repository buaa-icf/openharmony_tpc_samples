...
export abstract class CardObject extends SerializableObject {
    ...
    protected _renderedElement?: FrameNode;
     ...
     */
    protected contains(node: FrameNode): boolean {
        if (this._renderedElement) {
            return this._renderedElement == node;
        }
        return false;
    }
    ...
    get renderedElement(): FrameNode | undefined {
