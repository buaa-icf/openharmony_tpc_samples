...
| [图片相关](https://gitee.com/openharmony-tpc/ImageKnife) |图片处理工具类     |ohpm install @ohos/imageknife <br>  ohpm i imtype |
...
该功能模块基于 [ImageKnife](https://gitee.com/openharmony-tpc/ImageKnife) [imtype](https://github.com/fatelei/imagetype) 开发
