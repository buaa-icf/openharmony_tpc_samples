...
如果当前可选的encode方式没有符合要求，可以使用normalize方法自己提前预处理传入的路径。
...
更多模块的使用可参考[官方文档](https://github.com/pillarjs/path-to-regexp/blob/master/Readme.md)，[单元测试用例](https://gitcode.com/openharmony-tpc/openharmony_tpc_samples/blob/master/PathToRegexpDemo/TEST.md)详情可参考
...
使用过程中发现任何问题都可以提[Issue](https://gitcode.com/openharmony-tpc/openharmony_tpc_samples/issues) ，当然，也非常欢迎提[PR](https://gitcode.com/openharmony-tpc/openharmony_tpc_samples/pulls)共建。

## 开源协议

本项目基于 [MIT License ](https://gitcode.com/openharmony-tpc/openharmony_tpc_samples/blob/master/PathToRegexpDemo/LICENSE)，请自由地享受和参与开源。
