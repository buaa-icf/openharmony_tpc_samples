...
class ParseUser<T extends Attributes = Attributes> extends ParseObject<T> {
  ...
  linkWith(
    ...
    if (options && Object.prototype.hasOwnProperty.call(options, 'authData')) {
  ...
  stripAnonymity() {
    const authData = this.get('authData' as AttributeKey<T>);
    if (authData && typeof authData === 'object' && Object.prototype.hasOwnProperty.call(authData, 'anonymous')) {
  ...
  logIn(options: FullOptions & { context?: Attributes } = {}): Promise<ParseUser> {
    ...
    if (!Object.prototype.hasOwnProperty.call(loginOptions, 'usePost')) {
