...
function handleSelectResult(data: any, select: string[]) {
  ...
  select.forEach(field => {
    ...
    if (!hasSubObjectSelect && !Object.prototype.hasOwnProperty.call(data, field)) {
      ...
      pathComponents.forEach((component, index, arr) => {
        ...
        if (obj && !Object.prototype.hasOwnProperty.call(obj, component)) {
...
function copyMissingDataWithMask(src, dest, mask, copyThisLevel) {
  ...
  if (copyThisLevel) {
    for (const key in src) {
      if (Object.prototype.hasOwnProperty.call(src, key) && !Object.prototype.hasOwnProperty.call(dest, key)) {
        dest[key] = src[key];
      }
    }
  }
