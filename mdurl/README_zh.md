...
```shell
ohpm install mdurl
ohpm install @types/mdurl --save-dev //import mdurl 的时候语法报错.其原因是mdurl包内不含类型声明,需要 @types/mdurl 下载这个包的声明文件,从而解决语法的报错.
...
## 开源协议
本项目基于 [MIT License](https://gitcode.com/openharmony-tpc/openharmony_tpc_samples/blob/master/mdurl/LICENSE) ，请自由地享受和参与开源。
