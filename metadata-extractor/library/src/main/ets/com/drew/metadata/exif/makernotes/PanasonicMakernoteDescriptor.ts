...
class PanasonicMakernoteDescriptor extends TagDescriptor<PanasonicMakernoteDirectory> {
  ...
  public getImageStabilizationDescription(): string {
    return this.getIndexedDescription(PanasonicMakernoteDirectory.TAG_IMAGE_STABILIZATION,
      2,
      "On, Mode 1",
      "Off",
      "On, Mode 2"
  ...
  public getIntelligentExposureDescription(): string {
    return this.getIndexedDescription(PanasonicMakernoteDirectory.TAG_INTELLIGENT_EXPOSURE,
            "Off", "Low", "Standard", "High");
  }

  public getFlashWarningDescription(): string {
    return this.getIndexedDescription(PanasonicMakernoteDirectory.TAG_FLASH_WARNING,
  ...
  public getBracketSettingsDescription(): string {
    return this.getIndexedDescription(PanasonicMakernoteDirectory.TAG_BRACKET_SETTINGS,
  ...
  public getFlashCurtainDescription(): string {
    return this.getIndexedDescription(PanasonicMakernoteDirectory.TAG_FLASH_CURTAIN,
      "n/a", "1st", "2nd");
  }

  public getLongExposureNoiseReductionDescription(): string {
    return this.getIndexedDescription(PanasonicMakernoteDirectory.TAG_LONG_EXPOSURE_NOISE_REDUCTION, 1,
      "Off", "On");
  }
  ...
  public getIntelligentDRangeDescription(): string {
    return this.getIndexedDescription(PanasonicMakernoteDirectory.TAG_INTELLIGENT_D_RANGE,
      "Off", "Low", "Standard", "High");
  }

  public getClearRetouchDescription(): string {
    return this.getIndexedDescription(PanasonicMakernoteDirectory.TAG_CLEAR_RETOUCH,
      "Off", "On");
  }

  public getPhotoStyleDescription(): string {
    return this.getIndexedDescription(PanasonicMakernoteDirectory.TAG_PHOTO_STYLE,
     "Auto", "Standard or Custom", "Vivid", "Natural", "Monochrome", "Scenery", "Portrait");
  }

  public getShadingCompensationDescription(): string {
    return this.getIndexedDescription(PanasonicMakernoteDirectory.TAG_SHADING_COMPENSATION,
      "Off", "On");
  }
  ...
  public getCameraOrientationDescription(): string {
    return this.getIndexedDescription(PanasonicMakernoteDirectory.TAG_CAMERA_ORIENTATION,
  ...
  public getSweepPanoramaDirectionDescription(): string {
    return this.getIndexedDescription(PanasonicMakernoteDirectory.TAG_SWEEP_PANORAMA_DIRECTION,
      "Off", "Left to Right", "Right to Left", "Top to Bottom", "Bottom to Top");
  }

  public getTimerRecordingDescription(): string {
    return this.getIndexedDescription(PanasonicMakernoteDirectory.TAG_TIMER_RECORDING,
  ...
  public getShutterTypeDescription(): string {
    return this.getIndexedDescription(PanasonicMakernoteDirectory.TAG_SHUTTER_TYPE,
      "Mechanical", "Electronic", "Hybrid");
  }

  public getTouchAeDescription(): string {
    return this.getIndexedDescription(PanasonicMakernoteDirectory.TAG_TOUCH_AE,
      "Off", "On");
  }
  ...
  public getIntelligentResolutionDescription(): string {
    return this.getIndexedDescription(PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION,
      "Off", null, "Auto", "On");
  }
  ...
  public getWorldTimeLocationDescription(): string {
    return this.getIndexedDescription(PanasonicMakernoteDirectory.TAG_WORLD_TIME_LOCATION,
      1, "Home", "Destination");
  }

  public getAdvancedSceneModeDescription(): string {
    return this.getIndexedDescription(PanasonicMakernoteDirectory.TAG_ADVANCED_SCENE_MODE,
      1,
      "Normal",
  ...
  public getColorEffectDescription(): string {
    return this.getIndexedDescription(PanasonicMakernoteDirectory.TAG_COLOR_EFFECT,
  ...
  public getBurstModeDescription(): string {
    return this.getIndexedDescription(PanasonicMakernoteDirectory.TAG_BURST_MODE,
  ...
  public getNoiseReductionDescription(): string {
    return this.getIndexedDescription(PanasonicMakernoteDirectory.TAG_NOISE_REDUCTION,
      "Standard (0)", "Low (-1)", "High (+1)", "Lowest (-2)", "Highest (+2)"
    );
  }

  public getSelfTimerDescription(): string {
    return this.getIndexedDescription(PanasonicMakernoteDirectory.TAG_SELF_TIMER,
      1, "Off", "10 s", "2 s"
    );
  }
  ...
  public getAfAssistLampDescription(): string {
    return this.getIndexedDescription(PanasonicMakernoteDirectory.TAG_AF_ASSIST_LAMP,
      1, "Fired", "Enabled but not used", "Disabled but required", "Disabled and not required"
    );
  }

  public getColorModeDescription(): string {
    return this.getIndexedDescription(PanasonicMakernoteDirectory.TAG_COLOR_MODE,
      "Normal", "Natural", "Vivid"
    );
  }

  public getOpticalZoomModeDescription(): string {
    return this.getIndexedDescription(PanasonicMakernoteDirectory.TAG_OPTICAL_ZOOM_MODE,
      1, "Standard", "Extended"
    );
  }

  public getConversionLensDescription(): string {
    return this.getIndexedDescription(PanasonicMakernoteDirectory.TAG_CONVERSION_LENS,
  ...
  public getFocusModeDescription(): string {
    return this.getIndexedDescription(PanasonicMakernoteDirectory.TAG_FOCUS_MODE, 1,
  ...
  public getQualityModeDescription(): string {
    return this.getIndexedDescription(PanasonicMakernoteDirectory.TAG_QUALITY_MODE,
      2,
      "High", // 2
      "Normal",
      null,
  ...
  public getWhiteBalanceDescription(): string {
    return this.getIndexedDescription(PanasonicMakernoteDirectory.TAG_WHITE_BALANCE,
      1,
      "Auto", // 1
      "Daylight",
      "Cloudy",
