...
class NikonType1MakernoteDescriptor extends TagDescriptor<NikonType1MakernoteDirectory> {
  ...
  public getWhiteBalanceDescription(): string {
    return this.getIndexedDescription(NikonType1MakernoteDirectory.TAG_WHITE_BALANCE,
      "Auto",
      "Preset",
      "Daylight",
      "Incandescence",
  ...
  public getCcdSensitivityDescription(): string {
    return this.getIndexedDescription(NikonType1MakernoteDirectory.TAG_CCD_SENSITIVITY,
      "ISO80",
      null,
      "ISO160",
      null,
  ...
  public getImageAdjustmentDescription(): string {
    return this.getIndexedDescription(NikonType1MakernoteDirectory.TAG_IMAGE_ADJUSTMENT,
      "Normal",
      "Bright +",
      "Bright -",
      "Contrast +",
  ...
  public getColorModeDescription(): string {
    return this.getIndexedDescription(NikonType1MakernoteDirectory.TAG_COLOR_MODE,
      1,
      "Color",
      "Monochrome"
    );
  ...
  public getQualityDescription(): string {
    return this.getIndexedDescription(NikonType1MakernoteDirectory.TAG_QUALITY,
      1,
      "VGA Basic",
      "VGA Normal",
      "VGA Fine",
