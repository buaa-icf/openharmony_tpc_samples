...
class PcxDescriptor extends TagDescriptor<PcxDirectory> {
  ...
  public getVersionDescription(): string {
    ...
    return this.getIndexedDescription(PcxDirectory.TAG_VERSION,
  ...
  public getColorPlanesDescription(): string {
    return this.getIndexedDescription(PcxDirectory.TAG_COLOR_PLANES,
      3,
      "24-bit color",
      "16 colors");
  }
  ...
  public getPaletteTypeDescription(): string {
    return this.getIndexedDescription(PcxDirectory.TAG_PALETTE_TYPE,
      1,
      "Color or B&W",
      "Grayscale");
    }
