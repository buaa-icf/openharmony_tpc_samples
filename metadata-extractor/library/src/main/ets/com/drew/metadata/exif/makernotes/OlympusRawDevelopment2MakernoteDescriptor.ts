...
class OlympusRawDevelopment2MakernoteDescriptor extends TagDescriptor<OlympusRawDevelopment2MakernoteDirectory> {
  ...
  public getRawDevExposureBiasValueDescription(): string {
    return this.getIndexedDescription(OlympusRawDevelopment2MakernoteDirectory.TagRawDevExposureBiasValue,
      1, "Color Temperature", "Gray Point");
  }

  public getRawDevColorSpaceDescription(): string {
    return this.getIndexedDescription(OlympusRawDevelopment2MakernoteDirectory.TagRawDevColorSpace,
  ...
  public getRawDevNoiseReductionDescription(): string {
    ...
    if (((v >> 3) & 1) != 0) sb.concat("Noise Filter (Auto), ");
  ...
  public getRawDevEngineDescription(): string {
    return this.getIndexedDescription(OlympusRawDevelopment2MakernoteDirectory.TagRawDevEngine,
  ...
  public getRawDevPmBwFilterDescription(): string {
    return this.getIndexedDescription(OlympusRawDevelopment2MakernoteDirectory.TagRawDevPmBwFilter,
      "Neutral", "Yellow", "Orange", "Red", "Green");
  }

  public getRawDevPmPictureToneDescription(): string {
    return this.getIndexedDescription(OlympusRawDevelopment2MakernoteDirectory.TagRawDevPmPictureTone,
